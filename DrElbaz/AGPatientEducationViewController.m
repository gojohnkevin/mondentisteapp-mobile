//
//  AGPatientEducationViewController.m
//  DrElbaz
//
...
#import "AGPatientEducationViewController.h"
#import "SWRevealViewController.h"
#import "AFHTTPRequestOperationManager.h"
#import "AGUtils.h"

@interface AGPatientEducationViewController ()

@end

@implementation AGPatientEducationViewController
...
- (void)viewDidLoad
{
    ...
    [manager GET:userLocationURL parameters:nil success:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        [userDetails enumerateObjectsUsingBlock:^(id obj,NSUInteger idx, BOOL *stop){
            _textContent.text = [NSString stringWithFormat:@"%@",[obj objectForKey:@"patient_education"]];
        }];
...
- (void)viewDidLayoutSubviews {
    _textContent.frame = CGRectMake(0, 0, self.view.frame.size.width, self.view.frame.size.height);
}
